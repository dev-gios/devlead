...
1. **La rama por defecto se resuelve del remoto** (`git symbolic-ref refs/remotes/origin/HEAD`), nunca de configuración que DevLead pueda escribir. Sin esto, DevLead podría reapuntar qué cuenta como "rama por defecto" y mergear al tronco legalmente.
